...
/*******************************************************************************
 * Test pour l'instruction BGE
 ******************************************************************************/

void execute_type_B_BGE_should_return_non_zero_on_rs1_greater_than_15(){
    struct_B Struct_B;

    Struct_B.opcode = BRANCH_OPCODE;
    Struct_B.func3 = BGE_FUNCT3;
    Struct_B.rs1 = 16;
    Struct_B.rs2 = 2;
...
void execute_type_B_BGE_should_return_non_zero_on_rs2_greater_than_15(){
    struct_B Struct_B;
...
void execute_type_B_BGE_PC_equal_PC_plus_offset_if_src2_less_than_src_1(){
    struct_B Struct_B;
...
void execute_type_B_BGE_should_add_4_to_PC_if_src2_greater_than_src1(){
    struct_B Struct_B;
...
void RUN_TEST_execute_type_B_BGE(){
    RUN_TEST(execute_type_B_BGE_should_return_non_zero_on_rs1_greater_than_15);
    RUN_TEST(execute_type_B_BGE_should_return_non_zero_on_rs2_greater_than_15);
    RUN_TEST(execute_type_B_BGE_PC_equal_PC_plus_offset_if_src2_less_than_src_1);
    RUN_TEST(execute_type_B_BGE_should_add_4_to_PC_if_src2_greater_than_src1);
}

void RUN_TEST_execute_type_B_BGEU(){
    RUN_TEST(execute_type_B_BGE_should_return_non_zero_on_rs1_greater_than_15);
    RUN_TEST(execute_type_B_BGE_should_return_non_zero_on_rs2_greater_than_15);
    RUN_TEST(execute_type_B_BGE_PC_equal_PC_plus_offset_if_src2_less_than_src_1);
    RUN_TEST(execute_type_B_BGE_should_add_4_to_PC_if_src2_greater_than_src1);
}
void RUN_TEST_execute_type_B_BLTU(){
    RUN_TEST(execute_type_B_BGE_should_return_non_zero_on_rs1_greater_than_15);
    RUN_TEST(execute_type_B_BGE_should_return_non_zero_on_rs2_greater_than_15);
    RUN_TEST(execute_type_B_BGE_PC_equal_PC_plus_offset_if_src2_less_than_src_1);
    RUN_TEST(execute_type_B_BGE_should_add_4_to_PC_if_src2_greater_than_src1);
...
void RUN_TEST_execute_type_B(){
    ...
    RUN_TEST_execute_type_B_BGE();
    RUN_TEST_execute_type_B_BGEU();
    RUN_TEST_execute_type_B_BLTU();
}